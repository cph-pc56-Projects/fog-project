...
<html>
    ...
    <body class="w3-content w3-border-left w3-border-right">
        ...
        <div class="w3-main w3-white w3-padding-16 w3-card-2">
            <h1 class="w3-center">Carport 3</h1>   

            <!-- Slideshow Header -->
            <div class="w3-container w3-content" id="apartment">
               
                <div class="w3-display-container mySlides">
                    <img src="media/pictures/flat2.png" style="width:100%;margin-bottom:-6px">
            ...
            <div class="w3-row-padding w3-section">
                <div class="w3-col s3">
                    <img class="demo w3-opacity w3-hover-opacity-off" src="media/pictures/flat2.png" style="width:100%;cursor:pointer" onclick="currentDiv(1)" title="Living room">
                </div>
                <div class="w3-col s3">
